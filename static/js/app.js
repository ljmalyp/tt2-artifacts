...
function generateArtifacts() {
	...
	$.each(artifacts.data, function(k,v) {
		...
		row += '<tr class="collapse" id="' + k + 'info">';
			row += '<td colspan="5">';
				row += '<dl class="row">';
					row += '<dt class="col-3 text-right">Effect</dt>';
					row += '<dd class="col-9" id="' + k + 'effect"></dd>';
					row += '<dt class="col-3 text-right">Artifact Damage</dt>';
					row += '<dd class="col-9" id="' + k + 'ad"></dd>';
					row += '<dt class="col-3 text-right">Cost to Upgrade</dt>';
					row += '<dd class="col-9" id="' + k + 'cost"></dd>';
					row += '<dt class="col-3 text-right">Efficiency</dt>';
					row += '<dd class="col-9" id="' + k + 'eff"></dd>';
				row += '</dl>';
			row += '</td>';
		row += '</tr>';
				...
				suggestions += '<div class="collapse" id="' + k + 'deets" aria-labelledby="' + k + 'deetsh" data-parent="#suggestions">';
					suggestions += '<div class="card-body">';
						suggestions += '<dl class="row">';
							suggestions += '<dt class="col-3 text-right">Levels</dt>';
							suggestions += '<dd class="col-9">' + v.level + ' => ' + temp_artifacts.data[k].level + '</dd>';
							suggestions += '<dt class="col-3 text-right">Effect</dt>';
							suggestions += '<dd class="col-9">' + displayEffect(artifacts.data[k].current_effect, artifacts.data[k].type) + ' => ' + displayEffect(temp_artifacts.data[k].current_effect, artifacts.data[k].type) + '</dd>';
							suggestions += '<dt class="col-3 text-right">Artifact Damage</dt>';
							suggestions += '<dd class="col-9">' + displayPct(artifacts.data[k].current_ad) + ' => ' + displayPct(temp_artifacts.data[k].current_ad) + '</dd>';
						suggestions += '</dl>';
					suggestions += '</div>';
				suggestions += '</div>';
			suggestions += '</div>';
